...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      '.ucw-win.min .ucw-hdr-l{gap:12px!important}',
      ...
      '#ucw-root .ucw-win.full .ucw-hdr-acts{gap:3px!important;margin-right:8px!important}',
      ...
      '.ucw-hdr-l{display:flex!important;align-items:center!important;gap:14px!important;min-width:0!important}',
      '#ucw-root .ucw-hdr-av{width:40px!important;height:40px!important;border-radius:50%!important;overflow:hidden!important;flex-shrink:0!important;border:2px solid rgba(255,255,255,.3)!important;margin-left:4px!important}',
      ...
      '#ucw-root .ucw-hdr-acts{display:flex!important;gap:4px!important;flex-shrink:0!important;margin-right:4px!important}',
